 ...
 echo $this->Form->input('Visite_physique',array('type'=>'label','label'=>"Remplissez les informations correspondants à la viste physique que vous souhaitez proposer : "));
 ...
 echo $this->Form->input('Visite_physique.duree_physique',array('label'=>"Durée de la visite Physique : "));
