 ...
 echo $this->Form->input('Visite_audio.prix_audio',array('label'=>"Prix de la visite papier"));
 echo $this->Form->input('Visite_papier.duree_papier',array('label'=>"Durée de la visite papier (en minutes) : "));
